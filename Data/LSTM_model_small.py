...
x = LSTM(45, return_sequences=True, name='lstm_layer')(x)
x = GlobalMaxPool1D()(x)
x = Dropout(0.1)(x)
...
for i, label1 in enumerate(list_classes[0: -1]):
    for j, label2 in enumerate(list_classes[i+1:]):
        ...
        print("for model trained on {} and {}, accuracy is {} and {}, cost is {} ms".
              format(list_classes[i], list_classes[j], score1, score2, cost))
