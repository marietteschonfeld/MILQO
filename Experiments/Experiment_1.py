...
for query_num, query in enumerate(queries):
    ...
    item = [query_num, str(query), "model_opt", "cost", "CNF", len(flat_list(query))]
    ...
    item = [query_num, str(query), "order_opt", "cost", "CNF", len(flat_list(query))]
    for ablation_num, ablation in enumerate(ablations):
    ...
    item = [query_num, str(query), "model_opt", "cost", "DNF", len(flat_list(query))]
    for ablation_num, ablation in enumerate(ablations):
    ...
    item = [query_num, str(query), "order_opt", "cost", "DNF", len(flat_list(query))]
    for ablation_num, ablation in enumerate(ablations):
